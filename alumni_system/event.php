...
if(isset($_POST['add']))
{
    ...
    if(mysqli_num_rows($res)){
        ...
        mysqli_query($db,"INSERT into event values ('$a','$d','$e',now())");
        $err="<font color='green'>Events added Successfully</font>";
    }
...
<a href="main2.php" style=" color:white; font-size:20px; align:center;"><button type="submit" name="back" class="bt">Back</a></button>
    ...
    <div class="reg">
        <label>Select Date</label>
         <input type="date" name="form" placeholder=' Date' required>
    ...
    <div class="reg">
		...
		<textarea name="details"  placeholder="Detailed information of Events" required></textarea>
	</div><br>
    <div class=" reg">
