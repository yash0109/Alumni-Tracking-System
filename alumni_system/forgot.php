...
if(isset($_POST['sub'])){
    ...
    if(mysqli_num_rows($rec)){
        ...
        $mail->Username = 'k10@123';        // SMTP username
        $mail->Password = 'Ketan23@1999';                       // SMTP password
        $mail->SMTPSecure = 'tls';                            // Enable TLS encryption, `ssl` also accepted
        $mail->Port = 587;                                    // TCP port to connect to

        $mail->setFrom('ketanm.cse@sbjit.edu.in', 'admin');
        $mail->addAddress($email);                               // Add a recipient
        //$mail->addAddress('ellen@example.com');               // Name is optional
        $mail->addReplyTo('ketanm.cse@sbjit.edu.in', 'admin');
...
<html>
    ...
    <body>
       ...
       <div class="mid">
            <a href="alumni_login.php" style="  font-size:20px;  align:center;"><button type="submit" background-color:green name="back" class="btn">Back</a></button>
